...
var pages = {
  '/uri/': function uri(state) {
    return [h2('@magic-libraries/uri'), p([Link({
      to: 'https://magic.github.io/core'
    }, '@magic'), '-client library:', ' encode objects to uris and decode uri strings to objects']), GitBadges('magic-libraries/uri'), h3({
      id: 'installation'
    }, 'installation'), Pre('npm install --save-exact @magic-libraries/uri'), h3({
      id: 'usage'
    }, 'usage'), p('in a page/component, just use the lib.uri functions'), h4({
      id: 'usage-encode'
    }, 'encode'), Pre("\nlib.uri.encode({\n  host: 'https://example.com',\n  params: {\n    param_1: true,\n    param_2: 'string',\n  },\n})"), p('returns'), p(lib.uri.encode({
      host: 'https://example.com',
      params: {
        param_1: true,
        param_2: 'string'
      ...
      id: 'usage-decode'
    }, 'decode'), Pre("\nconst uri = 'https://example.com/?param_1=true&param_2=string'\nlib.uri.decode(uri)"), p('returns'), Pre(lib.json.stringify(lib.uri.decode('https://example.com?param_1=true&param_2=string'), null, 2)), h3({
      id: 'source'
